...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.setStorageSync('entrance', 'ynszlx2');
    app.editTabbar();
  ...
  toNextpage(e) {
    ...
    if (!wx.getStorageSync('userPhone')) { //判断是否包含userPhone字段
      ...
      if(topage=="zwpp"){
        wx.navigateTo({
          url: '/pages/zwpp/ynszlx2/zwpp',
        })
      }else if(topage=="lnfs"){
        wx.navigateTo({
          // url: '/pages/lnfs/ynkmgdxz/lnfs',
        })
      }
    }
