...
Page({
  ...
  toNextPage(e) {
    ...
    if (entrance == 'scdzsz') {
      wx.navigateTo({
        url: '/pages/home/sc/scdzsz/home',
      })
    } else if (entrance == 'scdzxbld') {
      wx.navigateTo({
        url: '/pages/home/sc/scdzxbld/scdzxbld',
      })
    } else if (entrance == 'scsz') {
      wx.navigateTo({
