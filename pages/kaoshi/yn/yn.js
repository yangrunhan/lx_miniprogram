...
Page({
  ...
  toNextPage(e) {
    ...
    if (entrance == 'ynszsz') {
      wx.navigateTo({
        url: '/pages/home/yn/ynszsz/home',
      })
    }
    else if (entrance == 'ynkmgdxz') {
      wx.navigateTo({
        url: '/pages/home/yn/ynkmgdxz/home',
      })
    }
    else if (entrance == 'ynkmszlx') {
      wx.navigateTo({
        url: '/pages/home/yn/ynkmszlx/home',
      })
    }
    else if (entrance == 'ynszlx2'){
      wx.navigateTo({
        url: '/pages/home/yn/ynszlx2/home',
      })
    }
