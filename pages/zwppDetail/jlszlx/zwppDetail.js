// pages/zwppDetail/jlszlx/zwppDetail.js
...
Page({
  ...
  getSearchData() {
    ...
    let _this = this;
    wx.request({
      url: 'https://zg99.offcn.com/index/chaxun/getlist/?actid=31483&callback=?',
      ...
      success: res => {
        ...
        if (data.status == 1) {
          ...
          if (data.msg == '暂无数据' && _this.data.searchData.zhuanye !='' && !_this.data.searchData.xueli !='' ) {
