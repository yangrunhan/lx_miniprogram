// pages/zwppDetail/scsz/zwppDetail.js
...
Page({
  ...
  onLoad: function (options) {
    if (options.searchData) { //参数
      ...
      wx.setNavigationBarTitle({
        title: searchData.year + searchData.xs + searchData.zhuanye + '检索详情',
      });
  ...
  getSearchData() {
    ...
    wx.request({
      url: 'https://zg99.offcn.com/index/chaxun/getlist/?actid=23776&callback=?',
