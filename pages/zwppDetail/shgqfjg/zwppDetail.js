// pages/zwppDetail/shgqfjg/zwppDetail.js
...
Page({
  ...
  onLoad: function (options) {
    if (options.searchData) { //参数
      ...
      if(searchData.xueli == "本科"){

        wx.setNavigationBarTitle({
          title: searchData.xueli + searchData.bk_zhuanye + '检索详情',
        });
      }else{
        
        wx.setNavigationBarTitle({
          title: searchData.xueli + searchData.yjs_zhuanye + '检索详情',
        });
      }
  ...
  inquire() {
    ...
    let bm = this.data.searchData.bm;
  ...
  getSearchData() {
    ...
    wx.request({
      url: 'https://zg99.offcn.com/index/chaxun/getlist/?actid=30769&callback=?',
