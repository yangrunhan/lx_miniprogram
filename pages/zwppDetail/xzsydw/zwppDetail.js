...
Page({
  ...
  onLoad: function (options) {
    if (options.searchData) { //参数
      ...
      wx.setNavigationBarTitle({
        title: searchData.year + searchData.zpbm + searchData.zhuanye + '检索详情',
      });
  ...
  inquire() {
    ...
    // 招聘部门
    let city = this.data.searchData.zpbm;
  ...
  getSearchData() {
    ...
    wx.request({
      url: 'https://zg99.offcn.com/index/chaxun/getlist/?actid=41154&callback=?',
