// pages/zwppDetail/zylx/zwppDetail.js
...
Page({
  ...
  onLoad: function (options) {
    if (options.searchData) { //参数
      ...
      wx.setNavigationBarTitle({
        title: searchData.year + '中央遴选检索详情',
      });
  ...
  inquire() {
    ...
    let areawork = this.data.searchData.area;
  ...
  getSearchData() {
    ...
    wx.request({
      url: 'https://zg99.offcn.com/index/chaxun/getlist/?actid=879&callback=?',
